...
import 'package:ware_house_project/src/client/Profile/bloc/cubit.dart';
...
class ProfileClient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => ProfileClientCubit()..showProfileDetails(),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          'card balance: ${profile.cardBalance}',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.blue,
            ...
            TextButton(
              onPressed: () {
                if (newName != null && newPhone != null && newEmail != null) {
                  parentContext.read<ProfileClientCubit>().editProfile(newName!, newPhone!, newEmail!);
                  print(newName);
                }
                Navigator.of(context).pop(); // Close the dialog
              },
            ...
            TextButton(
              onPressed: () {
                if (oldPassword != null && newPassword != null) {
                  parentContext.read<ProfileClientCubit>().changePassword(oldPassword!, newPassword!);
                }
                Navigator.of(context).pop(); // Close the dialog
              },
              child: Text('OK'),
