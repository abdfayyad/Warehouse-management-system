...
class WarehouseClientCubit extends Cubit<WarehouseClientStatus>{
  WarehouseClientCubit():super(WarehouseInitialized());
late WarehouseModel warehouseModel;
  Future<WarehouseModel?> getWarehouses() async {
    ...
    final response = await http.get(
        Uri.parse('${BASE_URL}/api/client/inventories'),headers: headers);
    print(headers);
