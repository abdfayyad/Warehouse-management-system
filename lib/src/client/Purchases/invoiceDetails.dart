...
class DetailsInvoice extends StatelessWidget {
   DetailsInvoice({super.key, required this.invoices});
            ...
            child: Container(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'money amount :${invoices!.totalAmount}\$',
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                  ...
                  Text(
                    'number of products :${invoices!.numberOfProducts}',
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.deepPurple),
              ...
              child: Container(
                  ...
                  child:Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: invoices!.items?.length??0, // Total number of items
                      itemBuilder:
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    '${invoices!.items![index].productImage}',
                                ...
                                Padding(
                                  ...
                                  const EdgeInsets.symmetric(
                                      horizontal: 8.0),
                                  child: Text(
                                    '${invoices!.items![index].productName}',
                                ...
                                Padding(
                                  ...
                                  const EdgeInsets.symmetric(
                                      horizontal: 8.0),
                                  child: Text(
                                    '\$${invoices!.items![index].productPrice}.00',
                                    style:const TextStyle(
                                      color:
                                      Colors.deepPurple,
                                      fontSize: 16.0,
